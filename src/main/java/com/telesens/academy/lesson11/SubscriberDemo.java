...
public class SubscriberDemo {
    ...
    //private static subscriberDataPath = "subscriber.txt";
...
//         //Супер-Коротко через ссылку на метод
        //subscribers.sort(Comparator.comparingLong(Subscriber::getId));// Сортировка по Id
        //subscribers.sort(new ComparatorComplexImpl());// Сотировка по возрасту и опреатору
        //subscribers.sort(Comparator.comparingLong(Subscriber::getAge));// Сортировка по полю age по убыванию
        subscribers.sort(new ComparatorByLastFirstNameImpl());// Сортировка по полю age по убыванию
...
//            }});
       ...
       // Новый лист в Excel
//        XSSFSheet sheet1 = workbook.createSheet("Numbers");
//        XSSFRow row1 = sheet1.createRow(0);
//        XSSFCell cellN = row1.createCell(0);
//        cellN.setCellValue("cellId");
