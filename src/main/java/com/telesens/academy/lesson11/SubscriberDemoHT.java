...
1)  Создать файл 'java-part.properties' следующие свойства:
		...
		male.firstnames=d:/myprojects/java-part/data/maleFirstNames.txt
		male.lastnames=d:/myprojects/java-part/data/maleLastNames.txt
		female.firstnames=d:/myprojects/java-part/data/femaleFirstNames.txt
		female.lastnames=d:/myprojects/java-part/data/femaleLastNames.txt
		# Диапазон возрастов
		age.from=5
		age.to=90
...
public class SubscriberDemoHT {
    ...
    public static void main(String[] args) {
        ...
        File file = new File("/Users/ivan/Downloads/task/java-part/java-part.properties");
        if (file.exists()) {
...
//              e.printStackTrace();
        ...
        for (Long i = 1L; i <= subscribersCount; i++) {
            ...
            //operator.setId(Operator.getId(operator.getName()));
...
*/
    ...
    public static String getRendomStringfromFile(String filePath) {
        String returnString = "";
